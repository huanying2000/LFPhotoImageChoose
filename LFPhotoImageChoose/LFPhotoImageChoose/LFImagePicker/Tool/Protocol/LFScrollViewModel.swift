...
@objc protocol LFScrollViewModel:LFPublicViewModel {
    //ScrollView 滚动时的回调
    // - Parameter contentOffSet: 当前滚动视图的偏移量
    @objc optional func scrollViewModel(didScrollContentOffSet:CGPoint)
...
@objc protocol LFTableCellViewModel:LFPublicViewModel {
    /// 获得当前indexPath显示的标题
    ///
...
@objc protocol LFTableViewModel:LFScrollViewModel,LFTableCellViewModel {
    /// tableView的group数量
    ///
...
@objc protocol LFCollectionCellViewModel : LFPublicViewModel
{
...
@objc protocol LFCollectionViewModel : LFScrollViewModel,LFCollectionCellViewModel
{
